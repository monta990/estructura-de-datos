...
namespace esdat
{
    public partial class FrmPosfijas : Form
    {
        ...
        /// <summary>
        /// Limpia los campos y pila del form
        /// </summary>
        ...
        /// <summary>
        /// Ejecuta la operación paso a paso y lo muestra en pantalla
        /// </summary>
        ...
        private void btmPasoaPaso_Click(object sender, EventArgs e) => Pasoapaso();
        ...
        private void btnEvaluar_Click(object sender, EventArgs e) => Evaluar();
    }
}